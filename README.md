...
- **Dynamic Tracker Fetcher:** Automatically pulls daily updates from `ngosang/trackerslist` (top 20 Tier-1 trackers) to prevent tracker rot without overwhelming the network with UDP floods.
